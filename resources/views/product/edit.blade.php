<x-app-layout>
    <div class="py-12 bg-gray-50 min-h-screen"> {{-- Latar luar abu sangat muda agar kontras --}}
                    ...
                    <form action="{{ route('product.update', $product) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name"
                                   ...
                                   focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-600 transition">
                            @error('name')
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="number" id="quantity" name="quantity"
                                       ...
                                       class="w-full px-4 py-2.5 rounded-lg border text-sm
                                       {{ $errors->has('quantity') ? 'border-red-600 bg-red-50' : 'border-gray-300 bg-white' }}
                                       text-gray-900 placeholder-gray-400
                                       focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-600 transition">
                                @error('quantity')
                                    <p class="mt-1.5 text-xs font-semibold text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" id="price" name="price"
                                       ...
                                       step="0.01"
                                       class="w-full px-4 py-2.5 rounded-lg border text-sm
                                       {{ $errors->has('price') ? 'border-red-600 bg-red-50' : 'border-gray-300 bg-white' }}
                                       text-gray-900 placeholder-gray-400
                                       focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-600 transition">
                                @error('price')
                                    <p class="mt-1.5 text-xs font-semibold text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <select id="user_id" name="user_id"
                                    class="w-full px-4 py-2.5 rounded-lg border text-sm
                                    {{ $errors->has('user_id') ? 'border-red-600 bg-red-50' : 'border-gray-300 bg-white' }}
                                    text-gray-900
                                    focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-600 transition">
                        ...
                        <div>
                            ...
                            <select id="category_id" name="category_id"
                                    class="w-full px-4 py-2.5 rounded-lg border text-sm
                                    {{ $errors->has('category_id') ? 'border-red-600 bg-red-50' : 'border-gray-300 bg-white' }}
                                    text-gray-900
                                    focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-600 transition">
                        ...
                        <div class="flex items-center justify-between pt-2">
                            <button type="submit"
                                    ...
                                    class="inline-flex items-center gap-1.5 px-3 py-2.5 text-sm font-medium rounded-lg text-red-500 hover:bg-red-50 transition">
