                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">Update the category information</p>
                        </div>
                    </div>
                    ...
                    {{-- Form --}}
                    <form action="{{ route('category.update', $kategori) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex gap-3 pt-2">
                            <button 
                                type="submit" 
                                class="flex-1 px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition"
                            >
                                Update Category
                            </button>
                            <a 
                                href="{{ route('category.index') }}" 
                                class="flex-1 px-6 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold rounded-lg transition text-center"
                            >
                                Cancel
                            </a>
                        </div>
